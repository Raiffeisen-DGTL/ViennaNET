...
using Company.WebApi.Core.DefaultConfiguration.Security;
using Company.WebApi.Core.Net;

namespace Company.WebApi.Core.DefaultConfiguration.Tests.Security
{
  ...
  public class JwtSecurityContextFactoryTests
  {
    ...
    public async Task Create_AuthenticatedIdentity_CorrectlyPutHeadersDataToContext()
    {
      ...
      fakeHeaderDictionary.Add(CompanyHeaders.RequestHeaderCallerIp, "123");
