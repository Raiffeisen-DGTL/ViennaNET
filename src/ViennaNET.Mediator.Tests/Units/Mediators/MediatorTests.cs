...
namespace ViennaNET.Mediator.Tests.Units.Mediators
{
  ...
  public class MediatorTests
  {
    ...
    public void SendCommandMessageAsyncTest()
    {
      Assert.That(async () =>
      {
        await _mediator.SendMessageAsync(new Command
        {
          Name = "Command one"
        });
      }, Throws.Nothing);
    ...
    public void SendCommandMessageAsyncWithoutReceiverTest()
    {
      Assert.That(async () =>
      {
        await _mediator.SendMessageAsync(new AlternateCommand
        {
          Name = "Alternate command one"
        });
    ...
    public void SendEventMessageAsyncTest()
    {
      Assert.That(async () =>
      {
        await _mediator.SendMessageAsync(new Event
        {
          Name = "Event one"
        });
      }, Throws.Nothing);
    ...
    public void SendEventMessageAsyncWithoutListenersTest()
    {
      Assert.That(async () =>
      {
        await _mediator.SendMessageAsync(new AlternateEvent
        {
          Name = "Event one"
        });
    ...
    [Test(Description = "Test asynchronously sending a unsupported message and expecting UnsupportedTypeMessageException.")]
    ...
    {
      return await _mediator.SendMessageAsync<Request, int>(new Request
      {
        Name = "Request one"
      });
    }
    ...
    [Test(Description = "Test asynchronously sending a unsupported request message and expecting UnsupportedTypeMessageException.")]
    ...
    public void SendCommandMessageTest()
    {
      Assert.That(() =>
      {
        _mediator.SendMessage(new Command
        {
          Name = "Command one"
        });
      }, Throws.Nothing);
    ...
    public void SendCommandMessageWithoutReceiverTest()
    {
      Assert.That(() =>
      {
        _mediator.SendMessage(new AlternateCommand
        {
          Name = "Alternate command one"
        });
      }, Throws.TypeOf<ExecuteCommandException>());
    ...
    public void SendCommandMessageToSeveralReceiversTest()
    {
      Assert.That(() =>
      {
        _altMediator.SendMessage(new AlternateCommand
        {
          Name = "Alternate command one"
        });
      }, Throws.TypeOf<ExecuteCommandException>());
    ...
    public void SendEventMessageTest()
    {
      Assert.That(() =>
      {
        _mediator.SendMessage(new Event
        {
          Name = "Event one"
        });
      }, Throws.Nothing);
    ...
    public void SendEventMessageWithoutListenersTest()
    {
      Assert.That(() =>
      {
        _mediator.SendMessage(new AlternateEvent
        {
          Name = "Event one"
        });
      }, Throws.TypeOf<PublishEventException>());
    ...
    [Test(Description = "Test synchronously sending a unsupported message and expecting UnsupportedTypeMessageException.")]
    ...
    {
      return _mediator.SendMessage<Request, int>(new Request
      {
        Name = "Request one"
      });
    }
    ...
    [Test(Description = "Test synchronously sending a unsupported request message and expecting UnsupportedTypeMessageException.")]
    ...
    {
      var sendCommandMessageTask = _mediator.SendMessageAsync(new Command
      {
        Name = "Command one"
      });
      var sendEventMessageTask = _mediator.SendMessageAsync(new Event
      {
        Id = 1,
        Name = "Event one"
      });
      var sendEventMessageTask2 = _mediator.SendMessageAsync(new Event
      {
        Id = 1,
        Name = "Event one"
      });
      var sendRequestMessageTask = _mediator.SendMessageAsync<Request, int>(new Request
      {
        Name = "Request one"
      });
    ...
    public void RegisterEventListenerTest()
    {
      Assert.That(() =>
      {
        ((IMessageRecipientsRegistrar)_mediator).RegisterEventListener<Event, AlternateEventListener>(new AlternateEventListener());
      }, Throws.Nothing);
    }
