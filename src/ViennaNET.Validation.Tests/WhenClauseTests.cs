...
namespace ViennaNET.Validation.Tests
{
  ...
  public class WhenClauseTests
  {
    ...
    [TestCaseSource(typeof(WhenRuleProvider), nameof(WhenRuleProvider.WhenRuleParameters))]
    ...
    [TestCaseSource(typeof(WhenRuleThrowsProvider), nameof(WhenRuleThrowsProvider.WhenRuleParameters))]
