...
namespace ViennaNET.Validation.Validators
{
  ...
  public class RulesValidatorAsync
  {
    ...
    public static Task<ValidationResult> ValidateAsync<T>(IValidationRuleSet<T> ruleSet, T instance,
    ...
    /// <param name="context">Контекст валидации</param>
    /// <returns>Результат валидации</returns>
    public static Task<ValidationResult> ValidateAsync<T>(IEnumerable<IRule<T>> rules, T instance,
      ValidationContext context = null)
    {
