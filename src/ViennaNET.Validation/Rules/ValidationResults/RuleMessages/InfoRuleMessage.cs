namespace ViennaNET.Validation.Rules.ValidationResults.RuleMessages
{
  ...
  public class InfoRuleMessage : BaseRuleMessage
  {
    ...
    public InfoRuleMessage(MessageIdentity identity, string error, params object[] args) : base(null, identity, null,
      error, args)
    {
    }
    ...
    /// <param name="error">����� ������</param>
    /// <param name="args">��������� ��� �������������� ������</param>
    public InfoRuleMessage(object state, string customCode, MessageIdentity identity, string error,
      params object[] args) :
