...
namespace ViennaNET.WebApi
{
  public sealed partial class ViennaHostBuilder
  {
    ...
    /// <inheritdoc />
    public IViennaHostBuilder AddExceptionHandler<TException>(int statusCode) where TException : Exception
    {
    ...
    /// <param name="statusCode">HTTP-код ошибки</param>
    /// <returns></returns>
    public IViennaHostBuilder AddExceptionHandler(Type exception, int statusCode)
    {
    ...
    /// <param name="statusCode">HTTP-код ошибки</param>
    /// <returns></returns>
    public IViennaHostBuilder AddExceptionHandler(Type exception, HttpStatusCode statusCode)
    {
