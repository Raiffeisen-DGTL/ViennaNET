...
namespace ViennaNET.Messaging.RabbitMQQueue.Tests
{
  ...
  public class RabbitMqQueueMessageAdapterConstructorTests
  {
    ...
    {
      Assert.Throws<ArgumentNullException>(() => _constructor.Create(QueueWithoutServerId),
    ...
    public void CreateAll_HasConfig_ReturnAdapters()
    {
      ...
      var constructor =
        new RabbitMqQueueMessageAdapterConstructor(fakeAdvancedBusFactory.Object, configuration,
          Given.FakeLoggerFactory);
