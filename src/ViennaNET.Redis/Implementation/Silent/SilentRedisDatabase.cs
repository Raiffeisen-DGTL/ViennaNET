...
namespace ViennaNET.Redis.Implementation.Silent
{
  internal class SilentRedisDatabase : IRedisDatabase
  {
    ...
    {
      return TryAct(db => db.ObjectGet<T>(key, flags));
    }
