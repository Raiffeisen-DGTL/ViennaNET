...
namespace ViennaNET.Messaging.Sending
{
  ...
  public interface ISerializedMessageSender<in TMessage> : IDisposable
  {
    ...
    /// <param name="correlationId"></param>
    /// <returns>Идентификатор отправленного сообщения</returns>
    string SendMessage(TMessage message, IReadOnlyDictionary<string, object> additionalProperties,
    ...
    /// <returns>Идентификатор отправленного сообщения</returns>
    Task<string> SendMessageAsync(TMessage message, string correlationId = null,
    ...
    /// <param name="cancellationToken"></param>
    /// <returns>Идентификатор отправленного сообщения</returns>
    Task<string> SendMessageAsync(TMessage message, IReadOnlyDictionary<string, object> additionalProperties,
