...
namespace ViennaNET.Messaging.Sending
{
  ...
  public interface IMessageSender : IDisposable
  {
    ...
    /// <returns>Идентификатор сообщения</returns>
    Task<string> SendAsync(BaseMessage message, IReadOnlyDictionary<string, object> additionalProperties = null,
    ...
    BaseMessage SendAndWaitReplyMessage(BaseMessage message,
    ...
    /// <param name="cancellationToken">Токен отмены <see cref="CancellationToken" /></param>
    /// <returns>Ответное сообщение</returns>
    Task<BaseMessage> SendAndWaitReplyMessageAsync(BaseMessage message,
