...
namespace Company.WebApi.Core.DefaultHttpSysRunner.Tests.Security
{
  ...
  public class NtlmSecurityContextFactoryTests
  {
    ...
    public void Create_RequestHeadersExists_TakeDataFromHeaders()
    {
      ...
      fakeHeaders.Add(CompanyHeaders.UserId, "hamster");
      fakeHeaders.Add(CompanyHeaders.RequestHeaderCallerIp, "some IP");
