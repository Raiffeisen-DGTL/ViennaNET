...
namespace ViennaNET.Messaging.Tests.Unit.DSL
{
  ...
  {
    private readonly LinkedList<IMessageAdapterConstructor> _constructors = new LinkedList<IMessageAdapterConstructor>();
    ...
    public MessagingConnectionCheckerBuilder WithConstructor(Func<MessageAdapterConstructorMock, IMessageAdapterConstructor> builder)
    {
