  ...
  public class RedisDatabaseTests
  {
    ...
    public void RedisDatabaseTestsSetUp()
    {
      ...
      databaseMock.Setup(x => x.StringGetAsync(It.IsAny<RedisKey>(), It.IsAny<CommandFlags>()))
        .Returns(Task.FromResult(
          (RedisValue)JsonConvert.SerializeObject(new FooDto { Name = "Name", Version = 123456 })));
      ...
      databaseMock.Setup(x => x.StringSetAsync(It.IsAny<RedisKey>(), It.IsAny<RedisValue>(), It.IsAny<TimeSpan?>(),
          It.IsAny<When>(),
      ...
      databaseMock.Setup(x => x.StringSetAsync(It.IsAny<KeyValuePair<RedisKey, RedisValue>[]>(), It.IsAny<When>(),
          It.IsAny<CommandFlags>()))
        .Returns(Task.FromResult(true));
      databaseMock.Setup(x => x.StringSet(It.IsAny<RedisKey>(), It.IsAny<RedisValue>(), It.IsAny<TimeSpan?>(),
          It.IsAny<When>(),
          It.IsAny<CommandFlags>()))
        .Returns(true);
      databaseMock.Setup(x =>
          x.StringSet(It.IsAny<KeyValuePair<RedisKey, RedisValue>[]>(), It.IsAny<When>(), It.IsAny<CommandFlags>()))
        .Returns(true);

      databaseMock.Setup(x => x.HashSetAsync(It.IsAny<RedisKey>(), It.IsAny<RedisValue>(), It.IsAny<RedisValue>(),
          It.IsAny<When>(),
          It.IsAny<CommandFlags>()))
        .Returns(Task.FromResult(true));
      databaseMock.Setup(x => x.HashSetAsync(It.IsAny<RedisKey>(), It.IsAny<HashEntry[]>(), It.IsAny<CommandFlags>()))
        .Returns(Task.FromResult(true));
      databaseMock.Setup(x => x.HashSet(It.IsAny<RedisKey>(), It.IsAny<RedisValue>(), It.IsAny<RedisValue>(),
          It.IsAny<When>(),
          It.IsAny<CommandFlags>()))
        .Returns(true);
      ...
      databaseMock.Setup(x => x.HashDeleteAsync(It.IsAny<RedisKey>(), It.IsAny<RedisValue>(), It.IsAny<CommandFlags>()))
        .Returns(Task.FromResult(true));
      databaseMock.Setup(x =>
          x.HashDeleteAsync(It.IsAny<RedisKey>(), It.IsAny<RedisValue[]>(), It.IsAny<CommandFlags>()))
        .Returns(Task.FromResult((long)0));
      _databaseMock = databaseMock;

      _redisDatabase = new RedisDatabase(false, _databaseMock.Object, new NullLogger<RedisDatabase>(),
        new Dictionary<string, TimeSpan> { { "default", TimeSpan.Zero } },
        "somePrefix");
    }
    ...
    public async Task KeyDeleteAsyncList_RedisDatabase_DatabaseMethodCalledCorrectly()
    {
      ...
      _databaseMock.Verify(
        x => x.KeyDeleteAsync(new RedisKey[] { "somePrefixkey", "somePrefixkey1" }, CommandFlags.None),
        Times.Once);
    }
    ...
    public void KeyDeleteList_RedisDatabase_DatabaseMethodCalledCorrectly()
    {
      ...
      _databaseMock.Verify(x => x.KeyDelete(new RedisKey[] { "somePrefixkey", "somePrefixkey1" }, CommandFlags.None),
        Times.Once);
    }
    ...
    public async Task HashDeleteAsyncList_RedisDatabase_DatabaseMethodCalledCorrectly()
    {
      ...
      _databaseMock.Verify(
        x => x.HashDeleteAsync("somePrefixkey", new RedisValue[] { "field", "field1" }, CommandFlags.None), Times.Once);
    }
    ...
    public void HashDeleteList_RedisDatabase_DatabaseMethodCalledCorrectly()
    {
      ...
      _databaseMock.Verify(
        x => x.HashDelete("somePrefixkey", new RedisValue[] { "field", "field1" }, CommandFlags.None),
        Times.Once);
    }
    ...
    public void ObjectGetList_RedisDatabase_DatabaseMethodCalledWithPrefix()
    {
      ...
      _databaseMock.Verify(x => x.StringGet(new RedisKey[] { "somePrefixkey", "somePrefixkey1" }, CommandFlags.None),
        Times.Once);
    }
    ...
    public async Task ObjectGetListAsync_RedisDatabase_DatabaseMethodCalledWithPrefix()
    {
      ...
      Assert.That(result.Last(), Is.EqualTo(new FooDto { Name = "Second", Version = 123654 }));
      _databaseMock.Verify(
        x => x.StringGetAsync(new RedisKey[] { "somePrefixkey", "somePrefixkey1" }, CommandFlags.None),
        Times.Once);
    }
    ...
    public void HashObjectGetList_RedisDatabase_DatabaseMethodCalledWithPrefix()
    {
      ...
      Assert.That(result.First(), Is.EqualTo(new FooDto { Name = "First", Version = 123456 }));
      Assert.That(result.Last(), Is.EqualTo(new FooDto { Name = "Second", Version = 123654 }));
      _databaseMock.Verify(x => x.HashGet("somePrefixkey", new RedisValue[] { "field", "field1" }, CommandFlags.None),
        Times.Once);
    }
    ...
    public async Task HashObjectGetListAsync_RedisDatabase_DatabaseMethodCalledWithPrefix()
    {
      ...
      Assert.That(result.Last(), Is.EqualTo(new FooDto { Name = "Second", Version = 123654 }));
      _databaseMock.Verify(
        x => x.HashGetAsync("somePrefixkey", new RedisValue[] { "field", "field1" }, CommandFlags.None), Times.Once);
    }
    ...
    public void ObjectSet_RedisDatabase_DatabaseMethodCalledCorrectly()
    {
      ...
      _databaseMock.Verify(
        x => x.StringSet("somePrefixkey", JsonConvert.SerializeObject(foo), null, When.Always, CommandFlags.None),
        Times.Once);
    }
    ...
    public async Task ObjectSetAsync_RedisDatabase_DatabaseMethodCalledCorrectly()
    {
      ...
      Assert.That(result, Is.EqualTo(true));
      _databaseMock.Verify(
        x => x.StringSetAsync("somePrefixkey", JsonConvert.SerializeObject(foo), null, When.Always, CommandFlags.None),
        Times.Once);
    }
    ...
    public void ObjectSetDictionary_RedisDatabase_DatabaseMethodCalledCorrectly()
    {
      ...
      _databaseMock.Verify(
        x => x.StringSet(
          new[] { new KeyValuePair<RedisKey, RedisValue>("somePrefixkey", JsonConvert.SerializeObject(foo)) },
    ...
    public void HashObjectSet_RedisDatabase_DatabaseMethodCalledCorrectly()
    {
      ...
      Assert.That(result, Is.EqualTo(true));
      _databaseMock.Verify(
        x => x.HashSet("somePrefixkey", "field", JsonConvert.SerializeObject(foo), When.Always, CommandFlags.None),
        Times.Once);
    }
    ...
    public async Task HashObjectSetAsync_RedisDatabase_DatabaseMethodCalledCorrectly()
    {
      ...
      Assert.That(result, Is.EqualTo(true));
      _databaseMock.Verify(
        x => x.HashSetAsync("somePrefixkey", "field", JsonConvert.SerializeObject(foo), When.Always, CommandFlags.None),
        Times.Once);
    }
    ...
    public void HashObjectSetDictionary_RedisDatabase_DatabaseMethodCalledCorrectly()
    {
      ...
      _databaseMock.Verify(
        x => x.HashSet("somePrefixkey", new[] { new HashEntry("field", JsonConvert.SerializeObject(foo)) },
          CommandFlags.None),
        Times.Once);
    }
    ...
    public async Task HashObjectSetDictionaryAsync_RedisDatabase_DatabaseMethodCalledCorrectly()
    {
      ...
      _databaseMock.Verify(
        x => x.HashSetAsync("somePrefixkey", new[] { new HashEntry("field", JsonConvert.SerializeObject(foo)) },
          CommandFlags.None),
        Times.Once);
    }
    ...
    public void ObjectSetLifetime_RedisDatabase_DatabaseMethodCalledCorrectly()
    {
      ...
      Assert.That(result, Is.EqualTo(true));
      _databaseMock.Verify(
        x => x.StringSet("somePrefixkey", JsonConvert.SerializeObject(foo), TimeSpan.Zero, When.Always,
          CommandFlags.None),
        Times.Once);
    }
    ...
    public async Task ObjectSetLifetimeAsync_RedisDatabase_DatabaseMethodCalledCorrectly()
    {
      ...
      Assert.That(result, Is.EqualTo(true));
      _databaseMock.Verify(
        x => x.StringSetAsync("somePrefixkey", JsonConvert.SerializeObject(foo), TimeSpan.Zero, When.Always,
          CommandFlags.None),
        Times.Once);
    }
    ...
    public void StringGetList_RedisDatabase_DatabaseMethodCalledWithPrefix()
    {
      ...
      _databaseMock.Verify(
        x => x.StringGet(new RedisKey[] { "somePrefixstringkey", "somePrefixstringkey1" }, CommandFlags.None),
        Times.Once);
    }
    ...
    public async Task StringGetListAsync_RedisDatabase_DatabaseMethodCalledWithPrefix()
    {
      ...
      _databaseMock.Verify(
        x => x.StringGetAsync(new RedisKey[] { "somePrefixstringkey", "somePrefixstringkey1" }, CommandFlags.None),
        Times.Once);
    }
    ...
    public void HashStringGetList_RedisDatabase_DatabaseMethodCalledWithPrefix()
    {
      ...
      _databaseMock.Verify(
        x => x.HashGet("somePrefixstringkey", new RedisValue[] { "field", "field1" }, CommandFlags.None), Times.Once);
    }
    ...
    public async Task HashStringGetListAsync_RedisDatabase_DatabaseMethodCalledWithPrefix()
    {
      ...
      _databaseMock.Verify(
        x => x.HashGetAsync("somePrefixstringkey", new RedisValue[] { "field", "field1" }, CommandFlags.None),
        Times.Once);
    }
    ...
    public void StringSet_RedisDatabase_DatabaseMethodCalledCorrectly()
    {
      ...
      _databaseMock.Verify(x => x.StringSet("somePrefixkey", "value", null, When.Always, CommandFlags.None),
        Times.Once);
    }
    ...
    public void StringSet_WithDiagnostic_RedisDatabase_DatabaseMethodCalledCorrectly()
    {
      ...
      _databaseMock.Verify(x => x.StringSet("somePrefixkey", "value_for_diag", null, When.Always, CommandFlags.None),
        Times.Once);
    }
    ...
    public async Task StringSetAsync_RedisDatabase_DatabaseMethodCalledCorrectly()
    {
      ...
      _databaseMock.Verify(x => x.StringSetAsync("somePrefixkey", "value", null, When.Always, CommandFlags.None),
        Times.Once);
    }
    ...
    public void StringSetDictionary_RedisDatabase_DatabaseMethodCalledCorrectly()
    {
      ...
      _databaseMock.Verify(
        x => x.StringSet(new[] { new KeyValuePair<RedisKey, RedisValue>("somePrefixkey", "value") }, When.Always,
          CommandFlags.None),
        Times.Once);
    }
    ...
    public async Task StringSetDictionaryAsync_RedisDatabase_DatabaseMethodCalledCorrectly()
    {
      ...
      _databaseMock.Verify(
        x => x.StringSetAsync(new[] { new KeyValuePair<RedisKey, RedisValue>("somePrefixkey", "value") }, When.Always,
          CommandFlags.None),
        Times.Once);
    }
    ...
    public void HashStringSet_RedisDatabase_DatabaseMethodCalledCorrectly()
    {
      ...
      _databaseMock.Verify(x => x.HashSet("somePrefixkey", "field", "value", When.Always, CommandFlags.None),
        Times.Once);
    }
    ...
    public async Task HashStringSetAsync_RedisDatabase_DatabaseMethodCalledCorrectly()
    {
      ...
      _databaseMock.Verify(x => x.HashSetAsync("somePrefixkey", "field", "value", When.Always, CommandFlags.None),
        Times.Once);
    }
    ...
    public void HashStringSetDictionary_RedisDatabase_DatabaseMethodCalledCorrectly()
    {
      ...
      _databaseMock.Verify(
        x => x.HashSet("somePrefixkey", new[] { new HashEntry("field", "value") }, CommandFlags.None),
        Times.Once);
    }
    ...
    public async Task HashStringSetDictionaryAsync_RedisDatabase_DatabaseMethodCalledCorrectly()
    {
      ...
      _databaseMock.Verify(
        x => x.HashSetAsync("somePrefixkey", new[] { new HashEntry("field", "value") }, CommandFlags.None),
        Times.Once);
    }
    ...
    public void StringSetLifetime_RedisDatabase_DatabaseMethodCalledCorrectly()
    {
      ...
      _databaseMock.Verify(x => x.StringSet("somePrefixkey", "value", TimeSpan.Zero, When.Always, CommandFlags.None),
        Times.Once);
    }
    ...
    public async Task StringSetLifetimeAsync_RedisDatabase_DatabaseMethodCalledCorrectly()
    {
      ...
      _databaseMock.Verify(
        x => x.StringSetAsync("somePrefixkey", "value", TimeSpan.Zero, When.Always, CommandFlags.None), Times.Once);
    }
  }
}