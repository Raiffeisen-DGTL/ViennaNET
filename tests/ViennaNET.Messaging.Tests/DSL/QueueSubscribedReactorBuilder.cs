...
namespace ViennaNET.Messaging.Tests.Unit.DSL
{
  ...
  {
    private readonly LinkedList<IMessageProcessor> _messageProcessors = new();
    ...
    public QueueSubscribedReactorBuilder WithMessageAdapter(
      Func<MessageAdapterBuilder, IMessageAdapterWithSubscribing> builder)
    {
