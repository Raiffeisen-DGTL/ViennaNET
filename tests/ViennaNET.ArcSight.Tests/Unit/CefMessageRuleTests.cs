...
namespace ViennaNET.ArcSight.Tests.Unit
{
  ...
  public class CefMessageRuleTests
  {
    public static object[] InvalidMessageCases()
    {
      ...
      return new object[]
      {
        new Action(() => new CefMessage(startTime, hostName, "", "threatmanager", "1.0", 100,
          "worm successfullystopped",
          CefSeverity.Emergency)),
        new Action(() => new CefMessage(startTime, hostName, "Security", "", "1.0", 100,
          "worm successfullystopped",
          CefSeverity.Emergency)),
        new Action(() => new CefMessage(startTime, hostName, "Security", "threatmanager", "", 100,
          "worm successfullystopped",
          CefSeverity.Emergency)),
        new Action(() =>
          new CefMessage(startTime, hostName, "Security", "threatmanager", "1.0", -100, "", CefSeverity.Emergency)),
        new Action(() => new CefMessage(default, hostName, "Security", "threatmanager", "1.0", -100, "",
          CefSeverity.Emergency)),
        new Action(() =>
          new CefMessage(startTime, null, "Security", "threatmanager", "1.0", -100, "", CefSeverity.Emergency)),
        new Action(() => new CefMessage(default, null, "Security", "threatmanager", "1.0", 100,
    ...
    public void Validate_ConstructedMessage_IsValid()
    {
      ...
      var msg = new CefMessage(DateTimeOffset.UtcNow, "host", "Security", "threatmanager", "1.0", 100,
        "worm successfullystopped",
        CefSeverity.Emergency);
