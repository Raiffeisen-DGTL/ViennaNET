  ...
  public class CefEncoderTests
  {
    ...
    public static object[] MessageCases()
    {
      ...
      return new object[]
      {
        new object[]
        {
          new CefMessage(startTime, "host", "Security", "threatmanager", "1.0", 100, "worm successfullystopped",
        ...
        new object[]
        {
          new CefMessage(startTime, "host", "Secu|rity", "threa|tmanager", "1.|0", 100, "worm suc|cessfullystopped",
            CefSeverity.Emergency),
          new CefMessage(startTime, "host", "Secu\\|rity", "threa\\|tmanager", "1.\\|0", 100,
            "worm suc\\|cessfullystopped",
            CefSeverity.Emergency)
        },
        new object[]
        {
          new CefMessage(startTime, "ho\\st", "Secu\\rity", "threat\\manager", "1.\\0", 100,
            "worm successful\\lystopped",
            CefSeverity.Emergency),
          new CefMessage(startTime, "ho\\\\st", "Secu\\\\rity", "threat\\\\manager",
            "1.\\\\0", 100, "worm successful\\\\lystopped",
            CefSeverity.Emergency)
        },
        new object[]
        {
          new CefMessage(startTime, "ho=st", "Security", "threatmanager", "1.0", 100, "worm successfullystopped",
            CefSeverity.Emergency),
          new CefMessage(startTime, "ho\\=st", "Security", "threatmanager", "1.0", 100, "worm successfullystopped",
            CefSeverity.Emergency)
        },
        new object[]
        {
          new CefMessage(startTime, "ho\rst", "Security", "threatmanager", "1.0", 100, "worm successfullystopped",
            CefSeverity.Emergency),
          new CefMessage(startTime, "ho\\rst", "Security", "threatmanager", "1.0", 100, "worm successfullystopped",
            CefSeverity.Emergency)
        },
        new object[]
        {
          new CefMessage(startTime, "ho\nst", "Security", "threatmanager", "1.0", 100, "worm successfullystopped",
            CefSeverity.Emergency),
          new CefMessage(startTime, "ho\\nst", "Security", "threatmanager", "1.0", 100, "worm successfullystopped",
            CefSeverity.Emergency)
        }
