...
{
  [TestFixture, Category("Unit"), TestOf(typeof(ArcSightClient))]
  public class ArcSightClientTests
  {
    ...
    public void Send_CorrectSettingsAndMessage_MessageCorrectlySent()
    {
      ...
      client.Send(new CefMessage(DateTime.Today, "host", "Security", "threatmanager", "1.0", 100, "worm successfullystopped",
    ...
    {
      Assert.Throws<ArcSightConfigurationException>(() => CreateClient("TestConfiguration/arcSightIncorrectSyslogVersion.json"),
